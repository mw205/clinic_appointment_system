...
<template>
    <div class="p-6 flex flex-col gap-6">
        ...
        <div v-else-if="store.summary" class="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <StatsCard title="No-Show Rate" :value="store.summary.no_show_rate + '%'"
                description="Of all appointments" />
            <StatsCard title="Confirmed" :value="store.summary.by_status?.confirmed ?? 0"
                description="Currently confirmed" />
            <StatsCard title="Completed" :value="store.summary.by_status?.completed ?? 0"
